    ...
    <div class="col-12">
      <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
        ...
        <div class="py-30 px-30">
          @if ($meditator->image)
            <form class="contact-form row y-gap-30" action="{{route('admin.meditator-reupload', ['meditator' => $meditator->id, 'asset' => $meditator->image->id])}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="col-12">
                <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Meditator image</label>
