    ...
    <div class="col-12">
      <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
        ...
        <div class="py-30 px-30">
          <form class="contact-form row y-gap-30" action="{{route('admin.emoji.store')}}" method="POST">
            @csrf
            <div class="col-12">
              <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Emoji text</label>
              <input name="text" type="text" placeholder="Emoji text">
            </div>
            <div class="col-12">
              <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Emoji icon</label>
              <input name="icon" type="text" placeholder="Emoji icon">
            </div>
