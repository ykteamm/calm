  ...
  <div class="row y-gap-30 pt-30">
    <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
      <div class="d-flex justify-between items-center py-20 px-30 border-bottom-light">
        <h2 class="text-17 fw-500">Gratitude control</h2>
        <a href="{{route('admin.gratitude.create')}}" class="text-14 text-purple-1 underline">Create</a>
      </div>
          ...
          <div class="d-flex" style="justify-content: space-between">
            ...
            <div class="d-flex items-center x-gap-20 y-gap-10 flex-wrap pt-10">
              <div class="d-flex items-center">
                ...
                <a href="{{route('admin.gratitude.show', ['gratitude' => $item->id])}}" class="text-14 text-purple-1 underline">Show</a>
              </div>
              <div class="d-flex items-center">
                <i class="icon-online-learning text-15 mr-10"></i>
                <a href="{{route('admin.gratitude.edit', ['gratitude' => $item->id])}}" class="text-14 text-purple-1 underline">Update</a>
              </div>
              <div class="d-flex items-center">
                <i class="icon-play text-15 mr-10"></i>
                <form action="{{route('admin.gratitude.destroy', ['gratitude' => $item->id])}}" method="POST">
                  @csrf
                  @method('delete')
