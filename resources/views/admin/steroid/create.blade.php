    ...
    <div class="col-12">
      <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
        ...
        <div class="py-30 px-30">
          <form class="contact-form row y-gap-30" action="{{route('admin.steroid.store')}}" method="POST">
            @csrf
            ...
            <div class="col-12">
                ...
                <input name="avg" type="number" class="form-control form-control-sm" placeholder="Avg">
            </div>
