    ...
    <div class="col-12">
      <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
        ...
        <div class="py-30 px-30">
          @if ($landscape->video)
            <form class="contact-form row y-gap-30" action="{{route('admin.landscape-reupload', ['landscape' => $landscape->id, 'asset' => $landscape->video->id])}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="col-12">
