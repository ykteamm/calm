    ...
    <div class="col-12">
      <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
        ...
        <div class="py-30 px-30">
          <form class="contact-form row y-gap-30" action="{{route('admin.landscape.update', ['landscape' => $landscape->id])}}" method="POST">
            @csrf
            @method('put')
            <div class="col-12">
              <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Landscape name</label>
              <input name="name" type="text" value="{{$landscape->name}}" placeholder="Landscape name">
            </div>
